import type { SiriSurface, AudioBands, SiriProgress } from './state';

export interface WavePreset {
	audioScale: number;
	uWhiteClip: number;
	uUnresolvedScale: number;
	uAmplitude: number;
	uFreq: number;
	uAberrationFreq: number;
	uWaveSpeed: number;
	uWaveScale: number;
	uAberration: number;
	uThickness: number;
	...
	uFalloff: number;
	uEdgeMask: number;
	uEdgeMaskInset: number;
	uBandFill: number;
	uBandFillThickness: number;
	uSoftness: number;
	uLowAmplitude: number;
	uLowIntensity: number;
	uMidAberration: number;
	uMidAberrationAmplitude: number;
	uMidBandFill: number;
	uMidSoftness: number;
	uHighAberration: number;
	uHighAberrationAmplitude: number;
}

export const WAVE_PRESETS: Record<string, WavePreset> = {
	bloom: {
		audioScale: 1,
		uWhiteClip: 1,
...
export function waveUniforms(surface: SiriSurface, bands: AudioBands, preset: WavePreset = WAVE_PRESETS.bloom) {
...
export function dotsUniforms(surface: SiriSurface, progress: SiriProgress[]) {
	return [
